...
function Overview({ onNavigate }) {
  ...
  return (
    <section className="animate-fade-in">
      ...
      {/* Key Facts Bar */}
      <div className="bg-blue text-white p-4 px-6 flex gap-8 flex-wrap mb-8">
        {[
      ...
      {/* Cards Grid */}
      <div className="grid gap-6 mb-10" style={{ gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))" }}>
        {cards.map((card) => (
          <div
            key={card.num}
